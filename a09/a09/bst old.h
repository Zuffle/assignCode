...
namespace custom
{
   ...
   /********************************************************************
    * BST - ERASE() : Removes an item from the BST :: DOES NOT WORK
    ********************************************************************/
   template <class T>
   void BST <T> :: erase(BST <T> :: iterator & it)
   {
//      if (NULL == it.getNode().pLeft && NULL == it.getNode().pRight)
//      {
